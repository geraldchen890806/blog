...
echo ""
echo "   1️⃣  读取文章内容（title、URL、完整原文）"
echo "   2️⃣  生成推文（≤280字符，含URL和标签）"
echo "   3️⃣  准备掘金内容（完整原文 + 引流链接）"
echo "   4️⃣  写入 .deploy-temp/summary.json 和 juejin.json"
echo "   5️⃣  通过 Telegram 发送确认消息给大人"
echo "   6️⃣  等待大人回复\"确认\""
echo "   7️⃣  执行 publish-to-social.cjs 发布"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
