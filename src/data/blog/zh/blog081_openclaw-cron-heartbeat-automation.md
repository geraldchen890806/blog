...
- 在主会话中执行（有完整上下文）
- 灵活的检查逻辑（可批量处理多个检查）
- 轻量级（HEARTBEAT_OK 响应成本极低，仅少量 output tokens）
- 可访问会话历史和记忆
...
> **说明**：以下 TypeScript 代码为概念示例，展示设计思路。实际使用时需要根据具体环境调整 import 和上下文。
...
**成本**：Haiku ≈ $0.25/1M input tokens（截至 2026 年 3 月，具体以 Anthropic 官网定价为准）
...
**相关阅读**：
- [OpenClaw 入门实战：5分钟搭建你的自托管 AI 助手](https://chenguangliang.com/posts/openclaw-getting-started/) - OpenClaw 基础使用指南
- [AI Agent 记忆系统实战：OpenClaw Memory 最佳实践](https://chenguangliang.com/posts/blog074_openclaw-memory-best-practices/) - Memory 系统配合自动化使用

**延伸阅读**：
- [OpenClaw 官方文档 - Cron Jobs](https://docs.openclaw.ai/)
- [OpenClaw 官方文档 - Heartbeat](https://docs.openclaw.ai/)
