...
tags:
  ...
  - 开发效率
  - 自动化
description: 腾讯 WorkBuddy 2026/3/9 上线，3 月月访问 8.85M、环比 +831%，DAU 是第 2 名 3-4 倍。同期 Claude Code / Codex CLI 在海外开发者圈封王。两条路一个 messaging-first 一个 terminal-first，背后是中美 agent 产品哲学的真实分叉。这篇基于公开资料拆 WorkBuddy 增长背后 4 个结构性决策，以及国内创业者从中能学到的差异化路径。
---
...
- 产品原型出自腾讯 CodeBuddy 团队约 10 人，**Wang Shengjie 带一个运营在 2026 年 1 月某个周末熬了两个通宵搭出来的**
...
腾讯选这条路有先天优势——微信、企业微信、QQ 是国内 IM 基础设施；同样的事情 Anthropic 做不了，因为没人在 Slack 里**指挥工程师工作**，工程师都自己在终端干活。
...
WorkBuddy 暴露的是**场景**——它的 Skills Gallery 内置了 **100+ 个 Expert Skills**（也就是文章前面提到的"100+ 内置专家角色"，官方口径是同一回事），覆盖发票处理、文档归档、竞品调研、内容创作、舆情分析、销售洞察、数据处理等高频场景。每一个都是一个完整 workflow，用户**选场景、塞素材、等结果**，不需要拼命想"我该让 AI 做什么、按什么顺序、用哪些工具"。
