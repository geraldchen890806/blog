...
tags:
  ...
  - 安全
  - 开发效率
description: 智谱 GLM 5.2 在 Semgrep IDOR 漏洞检测基准 F1 拿 39%，超过 Claude Code Opus 4.8（28%）11 个点、Opus 4.6（37%）2 个点，单次发现成本约 1/6。但综合 benchmark 它仍比 Claude Opus 系差约 2 分（91 vs ~93）。这种"综合差一截、特定场景反超"格局在 Kimi K2.5、Qwen3-Max 同期复现。本文拆"场景特化超越"是不是 2026 中国模型新拐点。
---
