...
> **🔥 已有 2026 年中更新版**：本文写于 2026 年 1 月，4 个月里模型层（GPT-5.5、Opus 4.7、Gemini 3.1）、价格层（普遍降 30-60%）、开源生态都发生了根本变化。**最新结论与选型建议见 [AI 大模型对比 2026 年中版](/posts/blog166_ai-models-mid-2026-update/)**。本文保留作为 4 月前的对比基线。
